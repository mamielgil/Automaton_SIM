...
export function NodeEditor(){
    ...
    return(
        ...
        <NodeEditorOption my_label = {"Node name: "} my_value_input={selected_node_data.name} onInputHandler={(event)=>Model.updateNodeId(event as Event,selected_node_data.id)} ></NodeEditorOption>
